...
function NewBrand({ initialData, isupdate = false, makePOSTApiRequest, makePUTApiRequest }) {
  ...
  async function onSubmit (formData) {
    console.log("🚀 ==> file: page.jsx:28 ==> onSubmit ==> formData:", formData);

    const prediction_result=await axios.post('http://127.0.0.1:5000/sckikit',formData)
    console.log("🚀 ==> file: page.jsx:32 ==> onSubmit ==> prediction_result:", prediction_result.data);
