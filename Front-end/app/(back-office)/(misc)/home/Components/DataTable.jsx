...
import DeleteBtn from '../../../GeneralComponents/DeleteBtn'
...
export default function DataTable({ name, columns = [''], resourceTitle }) {
  ...
  const onSubmit = async (formData) => {
    ...
    const baseUrl = `http://https://smart-inventory-management-system-with-a1f2.onrender.com/api/v1/GeneralSales/TodaySales`;
